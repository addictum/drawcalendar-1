...
public class Com_member_controller {
	...
	public String insert_com_member(Com_memberVO vo, BrandVO brand, BrandDAO dao) {
		...
		brand.setBrand_code(vo.getBrand_name().toLowerCase().substring(0, 2));
	...
	public String select_com_member(Com_memberVO vo, BrandVO brand, BrandDAO dao, HttpSession session) {
